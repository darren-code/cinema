    ...
    */
    public function index()
    {
        $playing = DB::table('studios as s')
            ...
            ->select('pr.id','s.name','m.title','st.time','b.location')
            ->orderBy('pr.id')
            ->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.playing.edit ', compact('playing','data_studio','data_movie','data_showtime','data_branch'));
    }
    ...
    public function update(Request $req, $id)
    {
        ...
        $req->session()->flash('msg','Studio Allocation has been updated');
